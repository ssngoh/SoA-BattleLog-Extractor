...
//                linesToAnalyse = gv_lastFileLines;
//                gv_storeWeaponString = string.Empty;
//                gv_storeSupportWeaponString.Clear();
//                gv_storeRelationStats.Clear();
//            }
...
//                if (gv_blockCount > 30 && gv_blockState == BlockState.HEADER_NOT_FOUND)// || i + 1 >= lines.Length)
//                {
...
//                if (gv_blockCount >= (30 - gv_lastFileBlocksFound) && gv_blockState == BlockState.HEADER_NOT_FOUND)
//                {
